...
urlpatterns = [
    ...
    path('laporan-bulanan-patroli/<str:periode>', views.laporan_bulanan_patroli, name='laporan_bulanan_patroli'),
    path('laporan-bulanan-apel/<str:periode>', views.laporan_bulanan_apel, name='laporan_bulanan_apel'),
    path('laporan-bulanan-cctv/<str:periode>', views.laporan_bulanan_cctv, name='laporan_bulanan_cctv'),
